...
const APPS = [
  ...
  },
  {
    ...
    // （client-techops を見ていない検査が3本ある）に対応
    app: '制作資料 (client-techops)',
    routes: 'client-techops/src/App.tsx',
    decl: 'client-techops/src/pcOnlyScreens.ts',
    pcConst: 'TECHOPS_PC_ONLY',
    okConst: 'TECHOPS_MOBILE_OK',
  },
  {
