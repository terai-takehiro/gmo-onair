...
**現在のバージョン**: v2.8.30 (dev) — **Hotfix**: ブラウザリサイズで CueTable がクラッシュするバグ修正 (`useMediaQuery` 後の early return による Rules of Hooks 違反を解消、ラッパ + 子コンポーネント分離で対応)。Phase 1〜4 の機能内容は v2.8.29 と同等。
