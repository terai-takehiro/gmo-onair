...
**現在のバージョン**: v2.8.28 (dev) — Qシート UI/UX モダン化 Phase 1+2 完了。Toast 基盤を shared に新設、Dashboard/Editor を DADS 化、EditorSidebar を 4 タブ + モバイル Sheet + FAB 化、HighlightPicker を Dialog 化、CueCardList/CueRowSheet/CueRowMobileEditor でスマホフル編集対応、CueTable lg 表形式を DADS 化、StageEditor を shared Dialog 化。Socket.IO + JSONB 構造は完全維持。
