    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          type: "callout",
          tone: "info",
          text: "タイマーはサーバーとリアルタイム同期（WebSocket）しているので、操作画面と表示画面が別のマシンでもズレません。残り時間に応じて通常→WARNING（黄）→TIME'S UP（赤・点滅＋グロウ）とフェーズが変わり、下端のプログレスバーと設定尺（/ MM:SS）で残量が一目で分かります。0 到達後は OVERTIME として超過時間（+MM:SS）を表示します。",
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          type: "bullets",
          items: [
            "中央に大きなタイマーとステータス（COUNTDOWN／WARNING／TIME'S UP／OVERTIME）が表示され、画面下端に残り時間のプログレスバーが出ます。WARNING／TIME'S UP では背景がうっすら色づいて遠目でもフェーズが分かります。",
