...
## 現在のバージョン
v2.8.24 — Qシート画像表示・ハイライト改善：①シナリオ画像をピル下に大きく表示（編集画面/印刷とも）②印刷で司会ピル＋画像を両立表示（バグ修正）③立ち位置図/スライド/シナリオ画像を印刷で最大200pxに拡大④立ち位置図を編集・ランダウンでも大きく表示⑤任意エントリに薄いハイライト背景色（黄/緑/青/桃/紫/橙）を付けられる機能を追加。編集/印刷/ランダウンすべてに反映
