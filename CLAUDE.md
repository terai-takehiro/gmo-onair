...
| 版ごとの変更 (全427件) | [docs/version-history.md](docs/version-history.md) |
...
> **これより前の版は [docs/version-history.md](docs/version-history.md) にあります**（v3.2.3 以下・424件）。
