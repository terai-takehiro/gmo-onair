 ...
 * @param minLevel - 最低限必要なアクセスレベル ('view' | 'edit' | 'full')
 */
export function requirePermission(module: string, minLevel: 'view' | 'edit' | 'full' = 'view') {
  const levelOrder = { view: 1, edit: 2, full: 3 };
