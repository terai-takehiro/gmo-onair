> **記録用（2026-09-08 に `docs/deploy-pipeline.md` から当時の全文をそのまま移した）。** v2.9.230 で VPS 上のフルビルドをやめて GitHub Actions ＋ GHCR に移行してから v4.1 までの経緯と実測。現行の説明は [docs/deploy-pipeline.md](../../deploy-pipeline.md)。
