...
2. **3-3-1 の観測期間が「意味のある」と言えるかは、まだユーザーの判断が要る**
   （CLAUDE.md の v4.1.7 と同様の判断。今回は検証・本番とも0件で、しかも
   3-3-2 の突き合わせも0件だったため、v4.1.7 のときより材料は強い）
3. 3-3-1・3-3-2 の判断が済み次第、次は工程表「7」（3-3-5 直前バックアップ+検証。
