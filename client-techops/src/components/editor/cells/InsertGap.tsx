    ...
    <div className="group relative h-7 flex items-center justify-center">
      ...
      <div className="absolute inset-0 flex items-center justify-center gap-1.5 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity pointer-events-none group-hover:pointer-events-auto group-focus-within:pointer-events-auto">
        <button
          ...
          className="px-2 py-1 text-[11px] font-medium rounded-control-md bg-card border border-primary/30 text-primary hover:bg-primary/10 shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
        ...
        <button
          ...
          className="px-2 py-1 text-[11px] font-medium rounded-control-md bg-card border border-warning/30 text-warning hover:bg-warning/10 shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
        ...
        <button
          ...
          className="px-2 py-1 text-[11px] font-medium rounded-control-md bg-card border border-info/30 text-info hover:bg-info/10 shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
