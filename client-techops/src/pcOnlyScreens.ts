...
export const TECHOPS_PC_ONLY: PcOnlyEntry[] = [
  ...
  {
    // 技術資料・書き出し（tech-docs.md §8）。用紙・出す内容を選びながら紙面の縮小プレビューと
    // 見比べる画面で、会場図面の仕上がり画面（`/techops/venue-layouts/:id/preview`）と同じ理由
    path: '/techops/tech-docs/:id/print',
    what: '技術資料の書き出し',
    why: '用紙と出す内容の設定を紙面の縮小プレビューと見比べながら組む画面で、狭い幅では組めません。',
    instead: { label: '技術資料の一覧を開く', to: '/techops/tech-docs' },
  },
  {
