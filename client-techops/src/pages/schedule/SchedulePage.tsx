...
import { createScheduleRefetchers } from "@/components/schedule/scheduleRefetch";
...
export default function SchedulePage() {
  ...
  const anySheetOpen = dialogOpen || columnDialog.open || venueOpen || settingsOpen || duplicateOpen;
  ...
  const { refetchDetail, refetchBreakdown, refetchListsAndHub, refetchAfterColumns, refetchAfterSettings, handleDeleted } =
    createScheduleRefetchers(id, queryClient, navigate, () => detailQuery.data);
