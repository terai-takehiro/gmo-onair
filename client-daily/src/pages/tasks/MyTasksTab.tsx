...
function ViewBtn({ active, onClick, icon: Icon, children }: {
  ...
  return (
    <button
      onClick={onClick}
      className={cn(
        'min-h-tap lg:min-h-[36px] flex items-center gap-1.5 rounded-md px-2.5 py-1.5 text-sub transition-colors',
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <button
          ...
          className={cn('min-h-tap lg:min-h-[36px] rounded-md px-3 py-1.5 text-sub', showDone ? 'bg-primary/15 font-bold text-primary' : 'text-muted-foreground hover:bg-accent')}
        >
          完了も表示
        </button>
