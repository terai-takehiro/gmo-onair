...
import { Loader2, User, Package, AlertCircle } from "lucide-react";
...
export default function LoginPage() {
  ...
  const handleLogin = async (userId: string) => {
    ...
    try {
      ...
      window.location.replace("/equipment/login?error=login_failed");
    }
  };
      ...
      <div className="glass-card animate-slide-up relative z-10 w-full max-w-2xl px-8 py-10">
        <div className="mb-8 text-center">
          ...
          <div className="inline-flex items-center justify-center gap-3 mb-3">
            ...
            <h1 className="text-3xl font-bold text-primary sm:text-4xl">機材管理</h1>
          </div>
