...
import { Plus, Trash2, ChevronUp, ChevronDown, Radio } from "lucide-react";
  ...
  return (
    <div className="lg:hidden space-y-3 p-3">
      ...
      {sections.map((sec, si) => (
        ...
        >
          <header className="flex items-center gap-2 px-3 py-2 bg-primary/10 border-b border-border">
            <input
              value={sec.label}
