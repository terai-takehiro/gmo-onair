...
import { CalendarDays, CheckCircle2, Eye, X, FileText, AlertTriangle, Lightbulb } from "lucide-react";
            ...
            <div key={stageHint.stage} className="flex flex-col gap-2 px-4 py-3 sm:flex-row sm:items-center sm:justify-between sm:px-6">
              ...
              <div className="flex shrink-0 items-center gap-2">
                ...
                >
                  ...
                  {settled ? "決まった" : "決まった にする"}
                </Button>
                <Button
                  size="sm"
                  variant="outline"
                  className={`min-h-[44px] ${watch ? "border-warning-border bg-warning-surface text-warning hover:bg-warning-surface" : ""}`}
                  disabled={pending}
