 ...
 *
 * 決算の取り込みと二重計上は**続けて使うもの**（入れる → 二重になっていないか調べる）
...
const STEPS: Record<Src, ImportStep[]> = {
  ...
  dedup: [
    { title: '重複の確認', desc: '手入力と決算の取り込みで二重になっている行を調べます' },
    { title: '確認する', desc: '削除する行と残す行を1件ずつ見比べる' },
    { title: '削除', desc: '決算の取り込み側だけを削除する（手入力は残ります）' },
  ],
};
