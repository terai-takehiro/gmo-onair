 ...
 * ── 理由の書き方 ──────────────────────────────────────────
 *
 * モックは「見積を送ったまま連絡がありません」のような具体的な理由を出しますが、
 * それを本当に言うには**ステージが変わった履歴**が要ります。いまの DB は
 * ステージ変更を記録していないので、サーバーは**今のステージから言えること**
 * だけを返します (`salesOverview.service` の `STUCK_WHY`)。作り話はしません。
 */
