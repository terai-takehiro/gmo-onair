 ...
 *
 * **制作資料 (`qsheet`) はここから外し、
 * 「イベントで使うもの」の段へ移しました**（M3）。凍結アプリで、
 * 案件の本番の日に開くものです。
 *
 * ⚠️ **消してはいけません。** `visibleApps()` は凍結3アプリを既定で外すので、
 * **上辺バーのアプリ切替にも左メニューにも凍結アプリは出ていません**。
 * つまり**押して開ける場所はトップのタイルだけ**で、消すと Qシート・
 ...
 */
export const DAILY_KEYS = ['sales', 'gpm', 'techops', 'budget', 'calendar', 'dailyops', 'equipment', 'admin'];
