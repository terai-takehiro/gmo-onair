 ...
 *
 * **`legal_entities.short_name`（migration 284 の実際の投入値）に合わせてある**——
 ...
 *
 * `SCS`/`GSS`/`GMO` はここでは**バッジに出さない**（3社とも和文の短縮名は
